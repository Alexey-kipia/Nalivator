...
//======== Пины Arduino NANO ========
  ...
  #define CLK  2              // CLK Энкодера для Arduino NANO
  #define DT  3               // DT Энкодера для Arduino NANO
  #define SW  4               // SW Энкодера для Arduino NANO
...
void ret_menu() {
  if (returnMenu && PAUSEtimer.isReady()) {
    ...
    else if (MenuFlag == 2) oled_Multirazliv();            // выходим в меню мультиналива
    else if (promivka) oled_Promivka(0);
